          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center space-x-2 bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-medium mb-6">
                ...
                <span>Professionelle Baureinigung seit 2014</span>
              </div>
              
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                Professionelle <span className="text-primary">Bauabschluss- & Baureinigung</span>
              </h1>
              
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Von der Bauschlussreinigung bis zur Grundreinigung nach Renovierung. 
                Über 500 Bauprojekte erfolgreich abgeschlossen - termingerecht und zuverlässig.
              </p>
              ...
              <div className="grid grid-cols-3 gap-6 pt-8 border-t border-gray-200">
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-gray-600">Termingerecht</div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              Unsere Baureinigung-Services
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Professionelle Reinigung für alle Bauphasen und Projektgrößen
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Termingerecht</h3>
              <p className="text-gray-600">
                Koordination mit Bauzeitplänen und zuverlässige Einhaltung 
                aller vereinbarten Termine.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Umfassende Haftpflicht- und Sachversicherung speziell 
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Lassen Sie sich unverbindlich beraten. Wir erstellen Ihnen ein maßgeschneidertes Angebot für Ihre Baureinigung.
            </p>
          </div>
                            ...
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                              <FormControl>
                                <SelectTrigger className="border-gray-300 focus:border-primary focus:ring-primary">
                                  <SelectValue placeholder="Bauabschlussreinigung" />
                                </SelectTrigger>
                              </FormControl>
                              <SelectContent>
