    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex items-center justify-between h-20">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/fensterreinigung" className="text-primary font-medium">Fensterreinigung</Link>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden border-t bg-white py-4">
              <div className="flex flex-col space-y-4">
                ...
                <Link href="/fensterreinigung" className="text-primary font-medium" onClick={() => setMobileMenuOpen(false)}>Fensterreinigung</Link>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center space-x-2 bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-medium mb-6">
                ...
                <span>Kristallklare Fenster seit 2014</span>
              </div>
              
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                Professionelle <span className="text-primary">Fenster- & Glasreinigung</span>
              </h1>
              
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Streifenfreie Ergebnisse mit modernster Osmose-Technik. Über 500 Kunden vertrauen 
                auf unsere Fensterreinigung für Büros, Geschäfte und Privathäuser.
              </p>
            ...
            <div className="relative">
              <img 
                src={heroImage}
                alt="Professionelle Fensterreinigung von Grema Gebäudeservice" 
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              Unsere Fensterreinigung-Services
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Kristallklare Ergebnisse für jede Art von Fenstern und Glas
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-sm border p-6">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Büro & Geschäfte</h3>
              <p className="text-gray-600 mb-4">
                Regelmäßige Fensterreinigung für Bürogebäude, Einzelhandel und Gewerbeobjekte. 
                Für einen professionellen Eindruck bei Ihren Kunden.
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-primary mr-2" />Schaufenster</li>
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-primary mr-2" />Bürofenster</li>
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-primary mr-2" />Glasfassaden</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Privathäuser</h3>
              <p className="text-gray-600 mb-4">
                Professionelle Fensterreinigung für Einfamilienhäuser, Mehrfamilienhäuser 
                und Wohnungen. Innen und außen.
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-primary mr-2" />Innen- & Außenreinigung</li>
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-primary mr-2" />Rahmenreinigung</li>
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-primary mr-2" />Rollladenkästen</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Osmose-Technik</h3>
              <p className="text-gray-600 mb-4">
                Modernste Osmose-Technologie für völlig streifenfreie Ergebnisse. 
                Umweltfreundlich ohne chemische Reinigungsmittel.
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-primary mr-2" />100% streifenfrei</li>
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-primary mr-2" />Umweltfreundlich</li>
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-primary mr-2" />Lange Sauberkeit</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Regelmäßige Termine</h3>
              <p className="text-gray-600 mb-4">
                Individuelle Reinigungsintervalle nach Ihren Wünschen. Wöchentlich, 
                monatlich oder quartalsweise.
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-primary mr-2" />Flexible Termine</li>
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-primary mr-2" />Zuverlässig</li>
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-primary mr-2" />Kostengünstig</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Schwer erreichbare Stellen</h3>
              <p className="text-gray-600 mb-4">
                Professionelle Ausrüstung für Oberlichter, hohe Fenster und 
                schwer zugängliche Glasflächen.
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-primary mr-2" />Teleskopstangen</li>
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-primary mr-2" />Hubarbeitsbühne</li>
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-primary mr-2" />Sicherheitsausrüstung</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border p-6">
              ...
              <p className="text-gray-600 mb-4">
                Umfassende Haftpflicht- und Sachversicherung für Ihre Sicherheit. 
                Erfahrene Mitarbeiter mit Sicherheitsschulung.
              </p>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-primary mr-2" />Haftpflichtversicherung</li>
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-primary mr-2" />Geschultes Personal</li>
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-primary mr-2" />Schadensfrei</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              Warum Grema für Ihre Fensterreinigung?
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Kristallklare Fenster, auf die Sie sich verlassen können
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Modernste Technik</h3>
              <p className="text-gray-600">
                Osmose-Anlagen und professionelle Ausrüstung für streifenfreie 
                Ergebnisse und lange Sauberkeit.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Über 15 authentische Google-Bewertungen mit 5 Sternen bestätigen 
                unsere hervorragende Qualität.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Zuverlässig & Pünktlich</h3>
              <p className="text-gray-600">
                Termintreue und gleichbleibende Qualität seit über 15 Jahren. 
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Lassen Sie sich unverbindlich beraten. Wir erstellen Ihnen ein maßgeschneidertes Angebot für Ihre Fensterreinigung.
            </p>
          </div>
                            ...
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                              <FormControl>
                                <SelectTrigger className="border-gray-300 focus:border-primary focus:ring-primary">
                                  <SelectValue placeholder="Fenster & Glas" />
                                </SelectTrigger>
                              </FormControl>
                              <SelectContent>
